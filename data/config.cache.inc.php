...
$cfg_cmspath = '';
$cfg_cookie_encode = 'DbpaHnUdGl7cngsueraFdSVOdq6K7c8V';
$cfg_indexurl = '/';
$cfg_backup_dir = 'backupdata';
$cfg_indexname = '首页';
$cfg_webname = '我的网站';
$cfg_adminemail = 'admin@dedebiz.com';
...
$cfg_softtype = 'zip|gz|rar|iso|doc|xsl|ppt|wps|jpg|png|jpeg|gif|webp|wbmp|pjpeg|heic';
...
$cfg_mb_album = 'Y';
$cfg_mb_upload = 'Y';
$cfg_mb_upload_size = 102400;
$cfg_mb_sendall = 'Y';
$cfg_mb_rmdown = 'Y';
$cfg_cli_time = 8;
$cfg_mb_addontype = 'swf|mpg|mp3|rm|rmvb|wmv|wma|wav|mid|mov|zip|rar|doc|xsl|ppt|wps|zip|gz|rar|iso|doc|xsl|ppt|wps|jpg|png|jpeg|gif|webp|wbmp|pjpeg|heic|mp4|pdf|docx|';
$cfg_mb_max = 500;
$cfg_keyword_like = 'N';
$cfg_index_max = 10000;
...
$cfg_smtp_port = '25';
$cfg_smtp_usermail = 'tianya@dedebiz.com';
$cfg_smtp_user = 'tianya';
$cfg_smtp_password = 'tianya';
$cfg_online_type = 'nps';
$cfg_upload_switch = 'Y';
