...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        {
            return "";
            // <li><span class=\"pageinfo\">共 <strong>1</strong>页<strong>".$this->TotalResult."</strong>条记录</span></li>\r\n
        }
        if($this->TotalResult == 0)
        {
            return "<p>暂未有数据，请稍后再来查看哦！！！</p>";
            // <li><span class=\"pageinfo\">共 <strong>0</strong>页<strong>".$this->TotalResult."</strong>条记录</span></li>\r\n
        }
        $purl = $this->GetCurUrl();
